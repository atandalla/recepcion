...
<head>
  ...
  .preloader {
    ...
    height: 380%;
    z-index: 9999;
    background: url('assets/img/carga4.gif') 50% 50% no-repeat;
    opacity: .8;
  }
...
<body>
    ...
    <div class="container text-center mt-5">
      <div class=" row">
        <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center text-center">
          <h3 class="label1 text-danger">Estamos procesando tu donación...</h3>
          <div class="preloader img-fluid ">
  ...
  <script type="text/javascript">
  setTimeout(function() {
    location.href = "enviado_correo.php?correo=<?php echo $correo ?>"
  }, 4000);
  </script>
