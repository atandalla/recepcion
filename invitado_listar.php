...
header('Content-Type: text/html; charset=utf-8');
 include 'includes/funciones/db_dispositivo.php';
    $query = "SELECT * FROM actarecepcion,tipo_dispositivo WHERE codigo_dispositivo='".$cod_ver."' AND tipo_dispositivo.id_tipodispositivo=actarecepcion.id_tipodispositivo";
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center text-center">
          <h3 class="label1">
            <p class="text-dark mt-5">Detalles de su dispositivo.
            </p>
            ...
            <table class="table table-responsive-md ">
              ...
              <tbody>
                <?php while($row = $resultado->fetch_assoc()) { 
                    ...
                    ?>
                <tr>
                  <td><?php echo utf8_decode($row['codigo_dispositivo']); ?></td>
                  <td><?php echo $row['tipo_dispositivo']; ?></td>
            ...
            <p class="text-dark"> Gracias por formar parte de la Universidad Politécnica Salesiana
            </p>

            <div class="col-md-12 mt-5">

              <a id="sesion2" href="#ModalDanger" data-toggle="modal" class="btn btn-primary btn-rounded" role="button"
                aria-pressed="true">Verificar otro
                dispositivo</a>
              <a href="invitado.php" class="btn btn-primary btn-rounded" role="button" aria-pressed="true">Volver al
                Menú</a>
            </div>
