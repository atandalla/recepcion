...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a id="sesion" href="#modalLoginForm" data-toggle="modal" class="get-started-btn">Iniciar Sesión</a>
      ...
      <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer d-flex justify-content-center">
            <input type="submit" class="btn btn-light-green" value="Ingresar">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center text-center">
          ...
          <div class="text-center">
            <a href="cita.php" class="btn-get-started scrollto">Conócenos</a>
          </div>
        </div>
